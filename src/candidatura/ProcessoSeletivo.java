...
public class ProcessoSeletivo {
    ...
    static void imprimirSelecionados() {
        ...
        for(int indice = 0; indice < candidatos.length; indice++) {
            System.out.println("O candidato de nº " + (indice + 1) + " eh o " + candidatos[indice]);
        }
    ...
    static void selecionaCandidatos() {
        String[] candidatos = {"FELIPE", "MARCIA", "JULIA", "PAULO", "AUGUSTO", "MONICA", "FABRICIO", "MIRELA", "JORGE", "DOUGLAS"};
